...
hook.Add("TTTUlxDynamicRCVars", "ttt2_ulx_dynamic_trapper_convars", function(tbl)
	...
	table.insert(tbl[ROLE_TRAPPER], {cvar = "ttt_trapper_tbutton_show_to_trapper", checkbox = true, desc = "ttt_trapper_tbutton_show_to_trapper (def. 1)"})
	table.insert(tbl[ROLE_TRAPPER], {cvar = "ttt_trapper_tbutton_show_to_others", checkbox = true, desc = "ttt_trapper_tbutton_show_to_others (def. 1)"})
end)
